...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        button_action = QAction(QIcon('../../icon/fugue-icons-3.5.6-src/icons/acorn.png'), 'Your button', self)
        ...
        button_action2 = QAction(QIcon('../../icon/fugue-icons-3.5.6-src/icons/animal-dog.png'), 'Your button', self)
